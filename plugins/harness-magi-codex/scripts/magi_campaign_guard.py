...
SCOPED_GLOBAL_CEILING_OVERRIDES: dict[str, dict[str, object]] = {
    ...
    "VVT_AJ_GRADIENT_V154_20260913.md": {
        "authority_id": "ZN6-VVT154-OWNER-AFK-AUDIT-2026-09-13-27-31",
        "doc_id": "0a34380799f6c9bd",
        "scope": (
            "VVT v15.4 exact design after immutable-attempt and truthful lean-scope "
        ...
        "drift_audit": {
            ...
            "prior_synthesis_sha256": (
                "dd42064625bde81e4ff6752076b669f4a805cdabfaa74afff45a248d1f5e7138"
            ),
            "authorized_artifact_sha256": (
                "ed3043003bf644237d0a3217a71ba44b6f9581af12ec2512761ec222f749e574"
            ),
            "remediated_roots": [
                "ops.recovery.unowned-staging-residue",
                "vvt154.attempt-state-identity",
                "commercial.scope.baseline_mismatch",
                "vvt154.checkonly-bootstrap-capacity",
            ],
            "measured_replay_peak_rss_kib": 2773072,
            "measured_replay_elapsed_seconds": 38.98,
            "design_lines_before": 515,
            "design_lines_after": 558,
...
def global_ceiling_policy(doc: Path) -> tuple[int, dict[str, object] | None]:
    ...
    if authority.get("authority_id") == "ZN6-01A-USER-ACK-2026-08-22-TO-36":
        ...
        authority.get("authority_id")
        == "ZN6-VVT154-OWNER-AFK-AUDIT-2026-09-13-27-31"
    ):
        exact_keys = {
            "authority_id", "doc_id", "scope", "authority_reference",
            "drift_audit", "authorized_artifact_sha256", "default_ceiling",
        ...
        specific_valid = (
            ...
            and authority.get("authorized_artifact_sha256")
            == "ed3043003bf644237d0a3217a71ba44b6f9581af12ec2512761ec222f749e574"
            and authority.get("previous_scoped_ceiling") == 28
            and authority.get("authorized_max_ceiling") == 31
            and authority.get("checkpoint_interval") == 4
            and authority.get("prior_usage") == 27
            and authority.get("additional_slots") == 4
